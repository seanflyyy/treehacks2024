...
const logs = new import_utils.DeploymentCommand("logs").summary("Watch logs from your deployment").description(
  ...
  parseInteger
).addDeploymentSelectionOptions("Watch logs from").showHelpAfterError().action(async (cmdOptions) => {
