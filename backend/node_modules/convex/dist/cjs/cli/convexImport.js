...
const convexImport = new import_utils.DeploymentCommand("import").summary("Import data from a file to your deployment").description(
...
).addDeploymentSelectionOptions("Import data into").argument("<path>", "Path to the input file").showHelpAfterError().action(async (filePath, options, command) => {
