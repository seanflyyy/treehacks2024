...
const dashboard = new import_utils.DeploymentCommand("dashboard").description("Open the dashboard in the browser").option(
  "--no-open",
  "Don't automatically open the dashboard in the default browser"
).addDeploymentSelectionOptions("Open the dashboard for").showHelpAfterError().action(async (options) => {
