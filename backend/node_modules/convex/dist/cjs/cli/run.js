...
const run = new import_utils.DeploymentCommand("run").description("Run a function (query, mutation, or action) on your deployment").argument(
  "functionName",
...
).option("--push", "Push code to deployment before running the function.").addOption(new import_commander.Option("--no-push").hideHelp()).addDeploymentSelectionOptions("Run the function on").addOption(
