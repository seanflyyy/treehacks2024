...
const convexExport = new import_utils.DeploymentCommand("export").summary("Export data from your deployment to a ZIP file").description(
...
).addDeploymentSelectionOptions("Export data from").showHelpAfterError().action(async (options) => {
