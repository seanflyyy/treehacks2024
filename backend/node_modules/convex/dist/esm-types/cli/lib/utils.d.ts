...
export declare class DeploymentCommand extends Command {
    /**
...
export declare function deploymentClient(deploymentURL: string, onError?: (err: any) => void): AxiosInstance;
