...
export const run = new DeploymentCommand("run").description("Run a function (query, mutation, or action) on your deployment").argument(
  "functionName",
...
).option("--push", "Push code to deployment before running the function.").addOption(new Option("--no-push").hideHelp()).addDeploymentSelectionOptions("Run the function on").addOption(
  new Option(
    "--typecheck <mode>",
